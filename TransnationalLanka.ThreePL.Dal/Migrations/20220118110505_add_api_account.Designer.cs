...
namespace TransnationalLanka.ThreePL.Dal.Migrations
{
    ...
    [Migration("20220118110505_add_api_account")]
    partial class add_api_account
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.Account", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.Audit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.Event", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.GoodReceivedNote", b =>
                {
                    ...
                    b.Property<long?>("ReturnGoodReceivedNoteId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ReturnGoodReceivedNoteId");
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.Invoice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.InvoiceItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.ProductStock", b =>
                {
                    ...
                    b.Property<decimal>("DamageStockQuantity")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("DispatchReturnQuantity")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("SalesReturnQuantity")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.Setting", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.UnitOfMeasure", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.UserWareHouse", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.GoodReceivedNote", b =>
                {
                    ...
                    b.HasOne("TransnationalLanka.ThreePL.Dal.Entities.GoodReceivedNote", "ReturnGoodReceivedNote")
                        .WithMany()
                        .HasForeignKey("ReturnGoodReceivedNoteId");
                    ...
                    b.Navigation("ReturnGoodReceivedNote");
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.InvoiceItem", b =>
                {
                    b.HasOne("TransnationalLanka.ThreePL.Dal.Entities.Invoice", null)
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.Product", b =>
                {
                    ...
                    b.HasOne("TransnationalLanka.ThreePL.Dal.Entities.UnitOfMeasure", "UnitOfMeasure")
                        .WithMany()
            ...
            modelBuilder.Entity("TransnationalLanka.ThreePL.Dal.Entities.UserWareHouse", b =>
                {
                    b.HasOne("TransnationalLanka.ThreePL.Dal.Entities.User", "User")
